...
export default function Home() {
	...
	return (
		<>
			<Navigation currentPage="Home" heroTitle="Nepal Travel & Tours" />
			<div className="min-h-screen bg-white text-black overflow-hidden">
				{/* Intro Section */}
				<section className="relative w-full h-screen flex justify-center items-center bg-black text-white">
				...
				>
					...
					>
						{/* Give Image a sized, relative wrapper so `fill` works */}
						<div className="relative w-full h-full">
							<Image
								src="/images/annapurna.jpg"
								alt="spotlight-bg"
								fill // replaces width/height
								priority // prevents layout shift on first paint
								sizes="100vw" // hint for responsive loading
								className="object-cover scale-150 will-change-transform"
								draggable={false}
							/>
						</div>
					</div>
