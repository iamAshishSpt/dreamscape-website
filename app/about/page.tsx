					...
					<div className="grid lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-lg text-gray-600 mb-6">
								...
								mountains and a desire to share their magic with the world. Our
								founders, native to the Himalayas, grew up exploring these peaks
								and understanding their sacred significance to the local
								communities.
							</p>
							<p className="text-lg text-gray-600 mb-8">
								...
								and creates lasting memories with our extended family of guides
								and porters.
							</p>
							<button
								type="button"
						...
						<div className="relative">
							...
							<div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
								<div className="flex items-center gap-3">
									...
									<div>
										<p className="font-semibold text-gray-900">Mount Everest</p>
			...
			<section className="py-20 bg-white">
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-gray-600 max-w-2xl mx-auto">
							Our people are your people, too. Meet the passionate team guiding
							DreamEscape's success.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="text-center">
							...
							<p className="text-blue-600 font-medium">Director of Marketing</p>
							<p className="text-gray-600 mt-3">
				...
				<div className="max-w-7xl mx-auto px-6">
					...
					<div className="grid md:grid-cols-3 gap-8">
						...
						<div className="bg-white p-8 rounded-xl shadow-lg">
							...
							<p className="text-gray-600 mb-6">
								"Best mountain adventure company in Nepal! The Manaslu trek was
								perfectly organized, and our guide Mingma was exceptional. The
								cultural insights and mountain views were unforgettable."
							</p>
							<div className="flex items-center">
				...
				<div className="max-w-7xl mx-auto px-6 text-center">
					...
					<div className="grid md:grid-cols-3 gap-8 mt-12">
						...
						<div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl">
							...
							<p className="text-blue-100 mb-4">
								Book a personalized consultation to discuss your dream mountain
								adventure and get expert recommendations.
							</p>
							<button
								type="button"
								className="bg-white text-blue-600 px-6 py-2 rounded-lg hover:bg-gray-100 transition-colors duration-300"
